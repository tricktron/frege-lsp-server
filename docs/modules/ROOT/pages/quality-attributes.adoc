...
The Frege IDE's architecture should satisfy the following quality attributes, also known as non-functionalm requirements, listed from highest to lowest priority.
