...
This last step is delgated to the https://github.com/eclipse/lsp4j[LSP4J] library. As a result, we just follow the guidelines and implement the hover binding as shown in xref:constraints.adoc#lsp4j[Constraints].