...
@Meta.FregePackage(
  ...
  time=1657090226178L, jmajor=11, jminor=-1,
  imps={
  ...
  symis={
    @Meta.SymI(
      offset=228, name=@Meta.QName(kind=0, pack="ch.fhnw.thga.fregelanguageserver.types.Range", base="Show_Range"),
    ...
    @Meta.SymI(
      offset=212, name=@Meta.QName(kind=0, pack="ch.fhnw.thga.fregelanguageserver.types.Range", base="Eq_Range"),
  ...
  symts={
    @Meta.SymT(
      offset=131, name=@Meta.QName(kind=0, pack="ch.fhnw.thga.fregelanguageserver.types.Range", base="Range"), typ=0,
      kind=10,
      cons={
        @Meta.SymD(
          offset=139,
          ...
          cid=0, typ=11,
          fields={
            @Meta.Field(name="start", offset=151, sigma=10, strict=false),
            @Meta.Field(name="end", offset=174, sigma=10, strict=false)
          }
        )
      },
      lnks={
  ...
  symls={
    @Meta.SymL(
      offset=139, name=@Meta.QName(pack="ch.fhnw.thga.fregelanguageserver.types.Range", base="Range"),
  ...
  sigmas={
    ...
    @Meta.Sigma(bound={"α"}, kinds={10}, rho=21), @Meta.Sigma(rho=22), @Meta.Sigma(rho=24)
  },
  exprs={@Meta.Expr()}
)
...
final public static class IShow_Range implements PreludeText.CShow<TRange> {
  ...
  final public static String/*<Character>*/ showsub(final TRange arg$1) {
    final Position.TPosition a2$7700 = arg$1.mem$end.call();
    final Position.TPosition a1$7699 = arg$1.mem$start.call();
    return ("(" + (((("Range" + " ") + Position.IShow_Position.showsub(a1$7699)) + " ") + Position.IShow_Position.showsub(
              a2$7700
            ))) + ")";
  }
  ...
  final public static String/*<Character>*/ show(final TRange arg$1) {
    final Position.TPosition a2$7697 = arg$1.mem$end.call();
    final Position.TPosition a1$7696 = arg$1.mem$start.call();
    return ((("Range" + " ") + Position.IShow_Position.showsub(a1$7696)) + " ") + Position.IShow_Position.showsub(
              a2$7697
            );
  }
  final public static String/*<Character>*/ showList(final PreludeBase.TList<TRange> arg$1, final String/*<Character>*/ arg$2) {
    return "[" + (PreludeText.joined(
              ...
              PreludeList.<String/*<Character>*/, TRange>map(
                    (Func.U<TRange, String/*<Character>*/>)((final Lazy<TRange> η$7912) -> Thunk.<
                          String/*<Character>*/
                        >shared((Lazy<String/*<Character>*/>)(() -> IShow_Range.show(η$7912.call())))),
                    arg$1
                  )
            ).call() + ("]" + arg$2));
  }
...
final public static class IEq_Range implements PreludeBase.CEq<TRange> {
  ...
  final public static int hashCode(final TRange arg$1) {
    final Position.TPosition a2$7694 = arg$1.mem$end.call();
    final Position.TPosition a1$7693 = arg$1.mem$start.call();
    return (31 * ((31 * ((31 * 1) + RunTM.constructor(arg$1))) + Position.IEq_Position.hashCode(
              a1$7693
            ))) + Position.IEq_Position.hashCode(a2$7694);
  }
  ...
  final public static boolean $eq$eq(final TRange arg$1, final TRange arg$2) {
    final Position.TPosition µ$$7730 = arg$1.mem$end.call();
    final Position.TPosition µ$$7729 = arg$1.mem$start.call();
    final Position.TPosition µ$$7732 = arg$2.mem$end.call();
    final Position.TPosition µ$$7731 = arg$2.mem$start.call();
    return Position.IEq_Position.$eq$eq(µ$$7729, µ$$7731) && Position.IEq_Position.$eq$eq(
              µ$$7730, µ$$7732
            );
  }
}
final public static class TRange implements frege.runtime.Value, Lazy<TRange> {
  ...
  final public static Position.TPosition start(final TRange arg$1) {
    final Position.TPosition a1$7675 = arg$1.mem$start.call();
    return a1$7675;
  }
  ...
  final public static Position.TPosition end(final TRange arg$1) {
    final Position.TPosition a2$7664 = arg$1.mem$end.call();
    return a2$7664;
  }
}
